...
fixed_parameters = {
    ...
    "EVAL_MODE": "full",
    "AGE_LEX_AGE_ORDER_LIMIT": "10",
    "RECOMB_PER_FUNC_SEQ_RECOMB_RATE": "0.0",
    "ORG_INJECTION_COUNT": "100",
    "TRACK_PHYLOGENY": "0"
}
...
combos.add_val(
    ...
    [
        "-SELECTION lexicase -ORG_INJECTION_MODE none -ORG_INJECTION_INTERVAL 10000",

        "-SELECTION age-lexicase -ORG_INJECTION_MODE random -ORG_INJECTION_INTERVAL 20",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-random -ORG_INJECTION_INTERVAL 20",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-complement -ORG_INJECTION_INTERVAL 20",

        "-SELECTION age-lexicase -ORG_INJECTION_MODE random -ORG_INJECTION_INTERVAL 100",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-random -ORG_INJECTION_INTERVAL 100",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-complement -ORG_INJECTION_INTERVAL 100",

        "-SELECTION age-lexicase -ORG_INJECTION_MODE random -ORG_INJECTION_INTERVAL 200",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-random -ORG_INJECTION_INTERVAL 200",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE recombine-complement -ORG_INJECTION_INTERVAL 200",
