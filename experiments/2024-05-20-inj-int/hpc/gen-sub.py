...
combos.register_var("ORG_INJECTION_INTERVAL")
combos.register_var("AGE_LEX_AGE_ORDER_LIMIT")
...
combos.add_val(
    ...
    [
        "-SELECTION lexicase -ORG_INJECTION_MODE none",
        "-SELECTION lexicase -ORG_INJECTION_MODE random",
        "-SELECTION age-lexicase -ORG_INJECTION_MODE random"
    ]
)
